import { MoreIcon, PlusIcon, RevokeIcon, SafeIcon } from '../../components'
...
export function DeviceList() {
  return (
    <div className="relative flex w-full max-w-[400px] select-none flex-col items-center justify-start p-6">
      ...
      <div className="mt-2 flex h-[60px] w-full cursor-pointer flex-row items-center justify-between gap-4 rounded-2xl border border-dashed border-stone-300/20 bg-white p-4 hover:bg-slate-600/10 active:bg-slate-600/20">
