  ...
  return (
    <>
      ...
      <div className="w-full px-6 pb-6 pt-[76px]" ref={transitionRef} style={transitionStyle}>
        <label className="mb-2 block text-[13px] text-[#5F6570]">{t`Generated by this device`}</label>
        <ul className="mb-3">
          <AddressItem
        ...
        {walletSnap.ckbAddresses && walletSnap.ckbAddresses?.length > 0 ? (
          <label className="mb-2 block text-[13px] text-[#5F6570]">{t`Associated with this device`}</label>
        ) : null}
        <ul className="mb-6">
