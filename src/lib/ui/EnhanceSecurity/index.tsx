...
export function EnhanceSecurity() {
  ...
  return (
    <div className="flex flex-col items-center justify-start px-6 py-20">
      ...
      <div className="my-5 self-stretch text-center text-[20px] font-bold text-neutral-700">
        Losing the current device will result in the loss of your assets.
      </div>
      <div className="self-stretch text-center text-[14px] font-normal leading-normal text-zinc-500">
